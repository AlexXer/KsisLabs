...
namespace tracert
{
    class Tracert
    {
        ...
        public Tracert(string IPOrName)
        {
        ...
        public void InitToSend()
        {
            ...
            Byte[] bSN = BitConverter.GetBytes(SequenceNumber);
        ...
        public string sendAndReceive()
        {
            ...
            while (true)
            {
                ...
                if (receiveType == 11 && receiveCode == 0 && receiveID == ID && receiveSN == SequenceNumber ||
